...
def solveGlover_diff(
    ...
    # m.printStats()
    m.write("Models_gurobi/lp/glover_diff.lp")
    ...
    if m.Status == GRB.OPTIMAL:
        ...
        m.computeIIS()
        m.write("Models_gurobi/lp/glover_diff.ilp")
        status = 3
...
def test():
    ...
    Sol, opt, status, time_execution, dic_nb_nodes = solveGlover_diff(K,n,x0,ytrue,U,L,W,b,epsilon,epsilon_adv,relax,parametres_gurobi)
