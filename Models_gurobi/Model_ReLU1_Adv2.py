...
def solve_F_ReLU1_Adv2(
    ...
    m.write("Models_gurobi/lp/F_ReLU1_Adv2.lp")
    ...
    if m.Status == GRB.OPTIMAL:
        ...
        m.computeIIS()
        m.write("Models_gurobi/lp/F_ReLU1_Adv2.ilp")
...
def test():
    ...
    relax = 1
    verbose = 1
    Sol,opt,status,time_exe,dic_nb_nodes = solve_F_ReLU1_Adv2(K,n,x0,y0,U,L,W,b,rho,epsilon,relax,parametres_gurobi,verbose)
    print("Sol : ", Sol)
