...
def solve_FprG_ReLU2_Adv2(
    ...
    # m.printStats()
    m.write("Models_gurobi/lp/M_2_2.lp")
    ...
    if m.Status == GRB.OPTIMAL:
        ...
        m.computeIIS()
        m.write("Models_gurobi/lp/M_2_2.ilp")
        status = 3
...
def test():
    ...
    Sol, opt, status, time_execution, dic_nb_nodes = solve_FprG_ReLU2_Adv2(K, n, x0, ytrue, U, L, W, b, epsilon, epsilon_adv, relax, parametres_gurobi)
