...
def solveG_RelU2_lin_Adv3(
    ...
    env.start()
    m = gp.Model("ReLU2lin_Adv3", env=env)
    ...
    # m.printStats()
    m.write("Models_gurobi/lp/G_Adv3_ReLU_2_lin.lp")
    ...
    if m.Status == GRB.OPTIMAL:
        ...
        m.computeIIS()
        m.write("Models_gurobi/lp/G_Adv3_ReLU_2_lin.ilp")
        status = 3
...
def test():
    ...
    epsilon_adv = 0.1
    relax = 1
    Sol, opt, status, time_execution, dic_nb_nodes = solveG_RelU2_lin_Adv3(K,n,x0,ytrue,U,L,W,b,epsilon,epsilon_adv,relax,parametres_gurobi)
