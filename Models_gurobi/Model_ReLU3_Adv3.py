...
def solve_ReLU3_Adv3(
    ...
    #m.printStats()
    m.write("Models_gurobi/lp/ReLU3_Adv3.lp")
    ...
    if m.Status == GRB.OPTIMAL:
        ...
        m.computeIIS()
        m.write("Models_gurobi/lp/ReLU3_Adv3.ilp")
        status = 3
...
def test():
    ...
    Sol, opt , status, time_ex, dic_nb_nodes = solve_ReLU3_Adv3(K,n,x0,ytrue,ycible,U,L,W,b,epsilon,epsilon_adv,relax,parametres_gurobi,verbose=1)
    print("Sol : ", Sol)
