...
def solveMix_SDP_objbetas(
    ...
    with mosek.Env() as env:
        with env.Task() as task:
            ...
            numcon = sum(n[1:K]) * 2 + 3 * n[K] + sum(n[1:K]) + n[0] + (n[K]-1) * 3 + n[0]
            ...
            if coupes["betai*betaj"]:
                ...
                num_contrainte = contrainte_produit_betas_nuls_Adv2_Adv3(task,K,n,ytrue,num_contrainte)
